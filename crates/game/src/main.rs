...
fn main_menu_setup(mut commands: Commands) {
    commands
        .spawn((
            // Changed here to add MainMenuUi marker
            Node {
...
mod tests {
    ...
    fn test_start_button_transitions_to_ingame() {
        ...
        // Simulate press
        app.world_mut()
            .entity_mut(start_button_entity)
        ...
        assert_eq!(
            state,
            &AppState::InGame,
            "State should be InGame after pressing Start"
        );
    }
    ...
    fn test_exit_button_closes_app() {
        ...
        assert!(
            !events.is_empty(),
            "AppExit event should be sent after pressing Exit"
        );
    }
}
